          ...
          <div className="hidden md:flex items-center">
            {user ? (
              <Link
                ...
                className="flex items-center space-x-2 px-5 py-2 rounded-full text-white bg-blue-600 hover:bg-blue-700 shadow-md transition-colors"
              >
                <FaUser />
                <span>Dashboard</span>
              </Link>
          ...
          <div className="flex flex-col p-6 space-y-4">
            ...
            <div className="pt-4 border-t">
              {user ? (
                <Link
                  to={ROUTES.ADMIN_DASHBOARD}
                  className="flex items-center justify-center space-x-2 w-full px-5 py-2 rounded-full text-white bg-blue-600 hover:bg-blue-700 shadow-md transition-colors"
                >
                  <FaUser />
                  <span>Dashboard</span>
                </Link>
